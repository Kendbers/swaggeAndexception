...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage(packagePath)).paths(PathSelectors.any()).build();
    }
    ...
    private ApiInfo apiInfo() {
        // API作者信息
        Contact contact = new Contact("云宏信息", "www.winhong.com", "wangyy@winhong.com");

        return new ApiInfoBuilder()
                .title("CNware WinStore 产品API文档")
                .description("WinStore产品Rest API文档")
                .termsOfServiceUrl("http://localhost:8002/springSecurity/doc.html")
                .version("3.1.0")
                .contact(contact)
                .build();
    }
...
/*
    ...
    *//**
    ...
    public Docket restfulApi() {
        //swagger的两种方式
        // System.out.println("http://localhost:8002" + contextPath + "/swagger-ui.html");
        System.out.println("http://localhost:8002" + contextPath + "/doc.html");
